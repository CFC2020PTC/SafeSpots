			...
			if (data != null) {
				...
				if(data["code"]){
					...
					window.location = "/DoUDetails.jsp";
						...
						group = data;
						fetchDoUPermissions(group["_id"]);
						// console.log(globalFeatureAccess);
						loadAttachments(group["_id"]);
						loadRevisionHistory(group["_id"]);
						
						// globalFeatureAccess updateDoU start
						if(globalFeatureAccess["updateDoU"] == "TRUE") {
							$("#dou-upload").css("display", "block");
							$("#dou-upload").attr("disabled", false);
						}
						else {
							$("#dou-upload").css("display", "none");
							$("#dou-upload").attr("disabled", true);
						}
						// globalFeatureAccess updateDoU end
						
						
						// globalFeatureAccess downloadDoU start
						if(globalFeatureAccess["downloadDoU"] == "TRUE") {
							$("#dou-download").css("display", "block");
							$("#dou-download").attr("disabled", false);
						}
						else {
							$("#dou-download").css("display", "none");
							$("#dou-download").attr("disabled", true);
						}	
						// globalFeatureAccess downloadDoU end
						
						
						// globalFeatureAccess editAccess start
						switch(globalFeatureAccess["editAccess"]) {
						  case "TRUE":
							$("#edit-access-btn").css("display","inline");
							$("#edit-access-btn").attr("disabled", false);
							$("#edit-access-modal input").val("");
						    break;
						  case "FALSE":
							$("#edit-access-btn").css("display","none");
							$("#edit-access-btn").attr("disabled", true);
						    break;
						  default:
							$("#edit-access-btn").css("display","none");
							$("#edit-access-btn").attr("disabled", true);
						...
						// globalFeatureAccess editAccess end
						
						
						// globalFeatureAccess delegateAccess start
						switch(globalFeatureAccess["delegateAccess"]) {
						  case "TRUE":
							$("#delegate-access-btn").css("display","inline");
							$("#delegate-access-btn").attr("disabled", false);
							$("#delegate-access-modal input").val("");
						    break;
						  case "FALSE":
							$("#delegate-access-btn").css("display","none");
							$("#delegate-access-btn").attr("disabled", true);
						    break;
						  default:
							$("#delegate-access-btn").css("display","none");
							$("#delegate-access-btn").attr("disabled", true);
						...
						// globalFeatureAccess delegateAccess end
						
						
						// globalFeatureAccess addReviewer start
						switch(globalFeatureAccess["addReviewer"]) {
						  case "TRUE":
							$("#add-reviewer-access-btn").css("display","inline");
							$("#add-reviewer-access-btn").attr("disabled", false);
							$("#add-reviewer-modal input").val("");
						    break;
						  case "FALSE":
							$("#add-reviewer-access-btn").css("display","none");
							$("#add-reviewer-access-btn").attr("disabled", true);
						    break;
						  default:
							$("#add-reviewer-access-btn").css("display","none");
							$("#add-reviewer-access-btn").attr("disabled", true);
						...
						// globalFeatureAccess addReviewer end
						
						// globalFeatureAccess reinitiate start
						switch(globalFeatureAccess["reinitiate"]) {
						case "TRUE":
							$("#re-initiate-btn").css("display","block");
							$("#re-initiate-btn").attr("disabled", false);
							$("#re-initiate-btn button").attr("disabled", false);
							break;
						case "FALSE":
							$("#re-initiate-btn").css("display","none");
							$("#re-initiate-btn").attr("disabled", true);
							$("#re-initiate-btn button").attr("disabled", true);
							break;
						default :
							$("#re-initiate-btn").css("display","none");
							$("#re-initiate-btn").attr("disabled", true);
						...
						// globalFeatureAccess reinitiate end
						
						// globalFeatureAccess cancelDoU start
						switch(globalFeatureAccess["cancelDoU"]) {
						case "TRUE":
							$("#cancel-btn").css("display","block");
							$("#cancel-btn").attr("disabled", false);
							$("#cancel-btn button").attr("disabled", false);
							break;
						case "FALSE":
							$("#cancel-btn").css("display","none");
							$("#cancel-btn").attr("disabled", true);
							$("#cancel-btn button").attr("disabled", true);
							break;
						default :
							$("#cancel-btn").css("display","none");
							$("#cancel-btn").attr("disabled", true);
						...
						// globalFeatureAccess cancelDoU end
						
						
						// globalFeatureAccess addComment Start
						switch(globalFeatureAccess["addComment"]) {
						case "TRUE":
							$("#post-comment").css("display","block");
							$("#comment-save-button").attr("disabled", false);
							break;
						case "FALSE":
							$("#post-comment").css("display","none");
							$("#comment-save-button").attr("disabled", true);
							break;
						default :
							$("#post-comment").css("display","none");
							$("#comment-save-button").attr("disabled", true);
						...
						// globalFeatureAccess addComment end
						
						
						
						// globalFeatureAccess addAttachment Start
						switch(globalFeatureAccess["addAttachment"]) {
						case "TRUE":
							$("#upload-attachment-button").css("display", "block");
							$("#upload-attachment-button").attr("disabled", false);
							$("#attachments-form").prop("disabled", false);
							break;
						case "FALSE":
							$("#upload-attachment-button").css("display", "none");
							$("#upload-attachment-button").attr("disabled", true);
							$("#attachments-form").prop("disabled", true);
							break;
						default :
							$("#upload-attachment-button").css("display", "none");
							$("#upload-attachment-button").attr("disabled", true);
						...
						// globalFeatureAccess addAttachment end
						
						$("#dou").attr("groupId",group["_id"]);
						$("#instruction").css("display", "none");
						$(".dynamic-block").css("display", "block");
						$("#status-change-btns").css("display", "none");

						$("#dou_name").text(group["dou_name"]);
						$("#created_time").text(getCurrentTimeZoneTime(group["created_time"]));
						$("#created_by").text(group["created_by"]);
						...
						if(group["dou_status"] == "PENDING") {
							...
							statusSuffix = getCurrentTimeZoneTimeWithTime(group["final_state_changed_on"]);
						}
						$("#dou_status_prefix_connector").text(statusPrefixConnector);
						$("#dou_status").text(status);
						$("#dou_status_suffix_connector").text(statusSuffixConnector);
						$("#dou_status_suffix").text(statusSuffix);
						
						
						
// $("#last_modified_by").text(group["last_modified_by"]);
						$("#dou_file_version").text("v"+group["dou_file_version"]);
						$("#last_modified_time").text(getCurrentTimeZoneTimeWithTime(group["last_modified_time"]));
						
						previousColor = currentColor
						currentColor = colorClass[group["dou_status"]]
						toggleClassColours(previousColor, currentColor);

						var accessTo = group["access_to"];
						loadAccessTo(accessTo)
						$("#access-list").collapse('hide'); // to close the
															// collapse
															// and make width
															// default initially
						searchPeople(); // enable search feature for access-list
						setCollapseEvents(); // enable collapse events for
												// access-list i.e change of
												// width
						populateComments(group["comments"]);
						$("#update-doufile-modal input").val("");
						$(".custom-file-label").html("Choose DoU");
						$("#edit-access-modal input").val("");
						
						replaceClass("#dropdown-"+$("#dou").attr("groupId"), "text-"+previousColor, "text-"+currentColor);
					}
			} else {
